package com.github.xero.istheapp.ui.activities.mainchild
...
import com.github.xero.istheapp.utils.ConstFun.isNotificationServiceRunning
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.HiddenCameraUtils.canOverDrawOtherApps
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.HiddenCameraUtils.openDrawOverPermissionSetting
import com.github.xero.istheapp.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.xero.istheapp.utils.ConstFun.openUseAccessSettings
import com.github.xero.istheapp.utils.checkForegroundApp.CheckPermission.hasUsageStatsPermission
...
import com.github.xero.istheapp.utils.ConstFun.isAddWhitelist
import com.github.xero.istheapp.utils.ConstFun.isAndroidM
import com.github.xero.istheapp.utils.ConstFun.openAccessibilitySettings
import com.github.xero.istheapp.utils.ConstFun.openNotificationListenerSettings
import com.github.xero.istheapp.utils.ConstFun.openWhitelistSettings
import com.github.xero.istheapp.utils.ConstFun.permissionRoot
import com.github.xero.istheapp.utils.ConstFun.showApp
import com.github.xero.istheapp.utils.Consts.CHILD_NAME
import com.github.xero.istheapp.utils.Consts.COMMAND_ADD_WHITELIST
import com.github.xero.istheapp.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY
import com.github.xero.istheapp.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY_1
import com.github.xero.istheapp.utils.Consts.COMMAND_ENABLE_NOTIFICATION_LISTENER
import com.github.xero.istheapp.utils.Consts.COMMAND_GRANT_PERMISSION
import com.github.xero.istheapp.utils.Consts.DEVICE_NAME
import com.github.xero.istheapp.utils.Consts.INTERVAL
import com.github.xero.istheapp.utils.Consts.PERMISSION_USAGE_STATS
import com.github.xero.istheapp.utils.Consts.TIMER
import com.github.xero.istheapp.utils.async.AsyncTaskRunCommand
import com.github.xero.istheapp.utils.checkForegroundApp.CheckPermission.getModeManager
