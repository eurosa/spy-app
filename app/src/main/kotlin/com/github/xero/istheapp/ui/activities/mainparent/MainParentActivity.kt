...
import com.github.xero.istheapp.data.model.Child
import com.github.xero.istheapp.data.preference.DataSharePreference.childSelected
import com.github.xero.istheapp.data.preference.DataSharePreference.clearAll
import com.github.xero.istheapp.data.preference.DataSharePreference.deviceChildSelected
import com.github.xero.istheapp.ui.activities.base.BaseActivity
import com.github.xero.istheapp.ui.activities.login.LoginActivity
import com.github.xero.istheapp.utils.ConstFun.startAnimateActivity
import com.github.xero.istheapp.utils.Consts.CALLS
import com.github.xero.istheapp.utils.Consts.DATA
import com.github.xero.istheapp.utils.Consts.KEY_LOGGER
import com.github.xero.istheapp.utils.Consts.PHOTO
import com.github.xero.istheapp.utils.Consts.SMS
import com.github.xero.istheapp.data.preference.DataSharePreference.finishAppState
import com.github.xero.istheapp.data.preference.DataSharePreference.listChild
import com.github.xero.istheapp.data.preference.DataSharePreference.lockPin
import com.github.xero.istheapp.data.preference.DataSharePreference.lockState
import com.github.xero.istheapp.ui.activities.lock.LockActivity
import com.github.xero.istheapp.ui.fragments.base.IOnFragmentListener
import com.github.xero.istheapp.ui.fragments.calls.CallsFragment
import com.github.xero.istheapp.ui.fragments.keylog.KeysFragment
import com.github.xero.istheapp.ui.fragments.maps.MapsFragment
import com.github.xero.istheapp.ui.fragments.message.MessageFragment
import com.github.xero.istheapp.ui.fragments.notifications.NotifyMessageFragment
import com.github.xero.istheapp.ui.fragments.photo.PhotoFragment
import com.github.xero.istheapp.ui.fragments.recording.RecordingFragment
import com.github.xero.istheapp.ui.fragments.setting.SettingFragment
import com.github.xero.istheapp.ui.fragments.social.SocialFragment
import com.github.xero.istheapp.utils.Consts.RECORDING
import com.github.xero.istheapp.utils.FileHelper.deleteAllFile
import com.github.xero.istheapp.utils.FileHelper.getUriPath
import com.pawegio.kandroid.longToast
import com.github.xero.istheapp.utils.ConstFun.find
import com.github.xero.istheapp.utils.ConstFun.listToStringChild
import com.github.xero.istheapp.utils.ConstFun.openGallery
import com.github.xero.istheapp.utils.ConstFun.startMain
import com.github.xero.istheapp.utils.ConstFun.stringToListChild
import com.github.xero.istheapp.utils.Consts.ADDRESS_AUDIO_CALLS
import com.github.xero.istheapp.utils.Consts.ADDRESS_AUDIO_RECORD
import com.github.xero.istheapp.utils.Consts.CHILD_NAME
import com.github.xero.istheapp.utils.Consts.CHILD_PHOTO
import com.github.xero.istheapp.utils.Consts.CHILD_SHOW_APP
import com.github.xero.istheapp.utils.Consts.CHILD_SOCIAL_MS
import com.github.xero.istheapp.utils.Consts.DEVICE_NAME
import com.github.xero.istheapp.utils.Consts.NOTIFICATION_MESSAGE
import com.github.xero.istheapp.utils.Consts.SOCIAL
import com.github.xero.istheapp.utils.Consts.TAG
import com.github.xero.istheapp.utils.Dialogs.showDialogAccount
import com.github.xero.istheapp.utils.HomeWatcher
